...
public class WorldSuperRift extends World {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final float BOUNDRY_RADIUS = 12000;
	private static final String[][] TEXTS = { { "ANOTHER DENSE ASTEROID RIFT" }, { "THIS TIME IT'S BIGGER!" } };
	private int phase;
	...
	public void start(GameState gameState) {
		...
		if (centreSpaceShip == null) {
			...
			for (int i = 0; i < 450; i++) {
				...
				if (r > BOUNDRY_RADIUS * 1.1f || r < 1100)
					collide = true;
				else
					// Check collision
				...
				if (!collide)
					addObject(new PAsteroidEnemyOrbiting(this, newx, newy, 0, 0, Math.max(1, (int) (r / 3000)), r > 5000 && r < 10000));
				else
					i--;
			}
	...
	public int getLeaderBoardID() {
		return R.string.leaderboard_super_rift;
	}
}
